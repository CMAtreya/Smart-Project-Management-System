...
export default function AdminProfile() {
  ...
  const recentActivity = [
    { id: 1, action: 'Created new project', target: 'Marketing Campaign', time: '2 hours ago' },
    { id: 2, action: 'Assigned task to', target: 'John Doe', time: '3 hours ago' },
    { id: 3, action: 'Updated project status', target: 'Website Redesign', time: '5 hours ago' },
    { id: 4, action: 'Completed task', target: 'Quarterly Report', time: '1 day ago' },
    { id: 5, action: 'Added new team member', target: 'Sarah Johnson', time: '2 days ago' },
  ];

  // Project statistics
  const statistics = [
    { label: 'Projects Managed', value: 12, icon: <FaChartLine className="text-blue-500" /> },
    { label: 'Team Members', value: 8, icon: <FaUser className="text-green-500" /> },
    { label: 'Tasks Completed', value: 145, icon: <FaCheckCircle className="text-purple-500" /> },
    { label: 'Hours Logged', value: 287, icon: <FaHistory className="text-orange-500" /> },
  ];
