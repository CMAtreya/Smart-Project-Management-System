...
export default function EditProject() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      const projectData = {
        ...
        description: 'Redesign the company website with modern UI/UX principles and improved performance.',
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold text-gray-800 dark:text-white mb-6">Edit Project</h1>
