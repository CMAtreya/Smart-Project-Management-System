...
export default function ProjectArchitecture() {
  ...
  useEffect(() => {
	...
	return (
		<>
			<Navbar />
			<div className="pt-16 min-h-screen bg-gray-900 bg-grid-pattern flex flex-col items-center py-10 px-2">
				<style>{`
          .bg-grid-pattern {
            background-image: 
        ...
        `}</style>
				...
				<div className="block md:hidden w-full max-w-md">
					{phases.map((phase, idx) => (
						<div key={phase.key} className="relative mb-8">
							{/* Phase Card */}
							<div
				...
				{/* Desktop Layout - Horizontal Flow with Zigzag */}
					...
					<div className="grid grid-cols-3 gap-8 relative">
						...
						<div className="flex flex-col items-center">
							...
							<div
								...
								tabIndex={0}
								role="button"
								aria-label={`Go to ${phases[0].title}`}
							>
								<div className="flex items-center mb-3">
									{phases[0].icon}
									<span className="ml-3 text-xl font-semibold text-white">
								...
								<div className="flex items-center mb-2">
									<span className={`text-xs font-medium ${statusColors[phases[0].status]}`}>
										{statusIcons[phases[0].status]}
										{phases[0].status}
									</span>
								</div>
							</div>
						...
						<div className="flex flex-col items-center">
							...
							<div
								...
								tabIndex={0}
								role="button"
								aria-label={`Go to ${phases[1].title}`}
							>
								<div className="flex items-center mb-3">
									{phases[1].icon}
									<span className="ml-3 text-xl font-semibold text-white">
								...
								<div className="flex items-center mb-2">
									<span className={`text-xs font-medium ${statusColors[phases[1].status]}`}>
										{statusIcons[phases[1].status]}
										{phases[1].status}
									</span>
								</div>
							</div>
						...
						<div className="flex flex-col items-center">
							...
							<div
								...
								tabIndex={0}
								role="button"
								aria-label={`Go to ${phases[2].title}`}
							>
								<div className="flex items-center mb-3">
									{phases[2].icon}
									<span className="ml-3 text-xl font-semibold text-white">
								...
								<div className="flex items-center mb-2">
									<span className={`text-xs font-medium ${statusColors[phases[2].status]}`}>
										{statusIcons[phases[2].status]}
										{phases[2].status}
									</span>
								</div>
								<div className="flex gap-2 mt-2">
						...
						<div className="flex flex-col items-center">
							...
							<div
								...
								tabIndex={0}
								role="button"
								aria-label={`Go to ${phases[5].title}`}
							>
								<div className="flex items-center mb-3">
									{phases[5].icon}
									<span className="ml-3 text-xl font-semibold text-white">
								...
								<p className="text-gray-300 mb-4 text-sm min-h-[48px]">
									{phases[5].description}
								</p>
								<div className="flex items-center mb-2">
									<span className={`text-xs font-medium ${statusColors[phases[5].status]}`}>
										{statusIcons[phases[5].status]}
										{phases[5].status}
									</span>
								</div>
							</div>
						...
						<div className="flex flex-col items-center">
							...
							<div
								...
								tabIndex={0}
								role="button"
								aria-label={`Go to ${phases[4].title}`}
							>
								<div className="flex items-center mb-3">
									{phases[4].icon}
									<span className="ml-3 text-xl font-semibold text-white">
								...
								<div className="flex items-center mb-2">
									<span className={`text-xs font-medium ${statusColors[phases[4].status]}`}>
										{statusIcons[phases[4].status]}
										{phases[4].status}
									</span>
								</div>
							</div>
						...
						<div className="flex flex-col items-center">
							...
							<div
								...
								tabIndex={0}
								role="button"
								aria-label={`Go to ${phases[3].title}`}
							>
								<div className="flex items-center mb-3">
									{phases[3].icon}
									<span className="ml-3 text-xl font-semibold text-white">
								...
								<div className="flex items-center mb-2">
									<span className={`text-xs font-medium ${statusColors[phases[3].status]}`}>
										{statusIcons[phases[3].status]}
										{phases[3].status}
									</span>
								</div>
							</div>
						...
						{/* Flow Arrows with Status Marks */}
						{/* Communication to Planning */}
						<div className="absolute top-[50%] left-[33%] transform -translate-y-1/2">
							<svg className="text-blue-400" width="60" height="24">
								<path
									d="M8 12 L52 12 M48 8 L52 12 L48 16"
									stroke="currentColor"
									strokeWidth="2"
									fill="none"
									strokeLinecap="round"
							...
							{/* Status mark based on Communication completion */}
							{phases[0].status === 'Completed' ? <CheckMark /> : <XMark />}
						</div>

						{/* Planning to Construction */}
						<div className="absolute top-[50%] left-[66%] transform -translate-y-1/2">
							<svg className="text-purple-400" width="60" height="24">
								<path
									d="M8 12 L52 12 M48 8 L52 12 L48 16"
									stroke="currentColor"
									strokeWidth="2"
							...
							{/* Status mark based on Planning completion */}
							{phases[1].status === 'Completed' ? <CheckMark /> : <XMark />}
						</div>

						{/* Construction to Modeling (diagonal down-left) */}
						<div className="absolute top-[50%] right-[8%] transform translate-y-8">
							<svg className="text-green-400" width="120" height="80">
								<path
									d="M20 20 Q60 20 100 60 M96 56 L100 60 L96 64"
									stroke="currentColor"
									strokeWidth="2"
									fill="none"
									strokeLinecap="round"
							...
							{/* Status mark based on Construction completion */}
							<div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
								{phases[2].status === 'Completed' ? <CheckMark /> : <XMark />}
							</div>
						</div>

						{/* Modeling to Deployment */}
						<div className="absolute bottom-[50%] right-[33%] transform translate-y-1/2">
							<svg className="text-yellow-400" width="60" height="24">
								<path
									d="M52 12 L8 12 M12 8 L8 12 L12 16"
									stroke="currentColor"
									strokeWidth="2"
									fill="none"
									strokeLinecap="round"
							...
							{/* Status mark based on Modeling completion */}
							{phases[3].status === 'Completed' ? <CheckMark /> : <XMark />}
						</div>

						{/* Deployment to Maintenance */}
						<div className="absolute bottom-[50%] left-[33%] transform translate-y-1/2">
							<svg className="text-pink-400" width="60" height="24">
								<path
									d="M52 12 L8 12 M12 8 L8 12 L12 16"
									stroke="currentColor"
									strokeWidth="2"
							...
							{/* Status mark based on Deployment completion */}
							{phases[4].status === 'Completed' ? <CheckMark /> : <XMark />}
						</div>
					</div>
				</div>
			</div>
